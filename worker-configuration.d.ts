/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e3e811c8b468409c097c8f0ce457283c)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DEVUSER_ACCESS_JWT: "devuser-local-token";
		SERVICE_TOKEN_ID: "service-id-local";
		SERVICE_TOKEN_SECRET: "service-secret-local";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_PROTECTION_ENABLED" | "DEVUSER_ACCESS_JWT" | "SERVICE_TOKEN_ID" | "SERVICE_TOKEN_SECRET" | "OPENAI_API_KEY" | "USE_MOCK_SPECIALISTS" | "USE_LIVE_SPECIALISTS" | "OPENAI_MODEL">> {}
}
